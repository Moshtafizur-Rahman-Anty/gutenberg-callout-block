 ...
 * Domain Path:       callout-and-alert-box
 *
 * @package Craftblocks
 */
 ...
 */
function craftblocks_callout_and_alert_box_block_init() {
	wp_register_block_types_from_metadata_collection( __DIR__ . '/build', __DIR__ . '/build/blocks-manifest.php' );
}
add_action( 'init', 'craftblocks_callout_and_alert_box_block_init' );
